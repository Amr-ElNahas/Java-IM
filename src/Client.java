...
class Client extends JFrame implements ActionListener {
	 ...
	 * System.out.println(Server2.GetMemberList().toString()); ArrayList<User>
	 * temp = Server1.GetMemberList(); temp.addAll(Server2.GetMemberList());
	 * return temp; }
	 */
	...
	public void help(){
		this.append("\"chat with <username>\" : connects to the user"+'\n'+"\"bye\" or \"quit\" or \"exit\" to quit"+ '\n'+"\"get members\" to get members"+'\n'+ "\"set ttl <number>\" to set time to live");
	}
	...
	public static void main(String argv[]) throws Exception {
		...
		while (true) {
			...
			/*
			 * if (sentence != null &&
			 * sentence.equalsIgnoreCase("show me what you got")) {
			 * System.out.println("here3"); ArrayList<User> temp =
			 * GetMemberList(); System.out.println(temp.toString()); for (int i
			 * = 0; i < temp.size(); i++) { System.out.println("fml");
			 * System.out.println(temp.get(i).username); } sentence = null; }
			 * else {
			 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		} else if (temp.length() >= 11 && temp.substring(0, 11).equalsIgnoreCase("get members")) {
			try {
				this.getMembersList();
			} catch (IOException e1) {
				// TODO Auto-generated catch block
		...
		}else if (temp.length() >= 4 && temp.substring(0, 4).equalsIgnoreCase("help")) {
			this.help();
		}
